...
namespace Spakov.W6t.Settings {
  ...
  internal static partial class SettingsHelper {
    ...
    private static readonly JsonSerializerOptions jsonSerializerOptions = new(SettingsContext.Default.Options);

    private static readonly List<string> issue105769WorkaroundProperties = [
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
    private static void EnhanceSchema(JsonNode? jsonNode) {
      ...
      if (jsonNode is JsonObject jsonObject) {
        if (jsonObject.Parent is null) {
          ...
          foreach (string property in issue105769WorkaroundProperties) {
    ...
    /// href="https://github.com/dotnet/runtime/issues/105769"/>, building out
    /// the color subschemas "by hand".
    /// </summary>
    /// <remarks>See <see
    /// href="https://github.com/dotnet/runtime/discussions/115196#discussioncomment-12996967"
    /// /> for a discussion about this. Probably slated to be implemented in
    /// .NET 11.</remarks>
