...
#pragma warning restore IDE0079 // Remove unnecessary suppression
    public void LoadSettings(bool initialLoad = false, bool terminalIsInitialized = false) {
      ...
      try {
        ...
        if (terminalIsInitialized) {
          ShowErrorDialog(TerminalControl.XamlRoot, resources.GetString("CouldNotReadSettings"), e);
        }
      } catch (JsonException e) {
        if (terminalIsInitialized) {
          ShowErrorDialog(TerminalControl.XamlRoot, resources.GetString("CouldNotLoadSettings"), e);
        }
      }
      ...
      if (settings.Basics is not null) {
        ...
        dependencyProperties.StartDirectory = settings.Basics.StartDirectory;
      }

      if (settings.Appearance is not null) {
        if (settings.Appearance.WindowBackdrop is not null) dependencyProperties.WindowBackdrop = (WindowBackdrops) settings.Appearance.WindowBackdrop;
        if (settings.Appearance.SolidColorWindowBackdropColor is not null) dependencyProperties.SolidColorWindowBackdropColor = (Color) settings.Appearance.SolidColorWindowBackdropColor;
      ...
      if (settings.Behavior is not null) {
        if (terminalIsInitialized) {
          if (settings.Behavior.UseVisualBell is not null) TerminalControl.UseVisualBell = (bool) settings.Behavior.UseVisualBell;
        }

        if (settings.Behavior.VisualBellDisplayTime is not null) dependencyProperties.VisualBellDisplayTime = (int) settings.Behavior.VisualBellDisplayTime;

        if (terminalIsInitialized) {
          if (settings.Behavior.UseContextMenu is not null) TerminalControl.UseContextMenu = (bool) settings.Behavior.UseContextMenu;
          if (settings.Behavior.UseExtendedContextMenu is not null) TerminalControl.UseExtendedContextMenu = (bool) settings.Behavior.UseExtendedContextMenu;
        }
      }

      if (settings.Cursor is not null) {
        if (terminalIsInitialized) {
          if (settings.Cursor.CursorStyle is not null) TerminalControl.CursorStyle = (CursorStyles) settings.Cursor.CursorStyle;
          if (settings.Cursor.CursorThickness is not null) TerminalControl.CursorThickness = (double) settings.Cursor.CursorThickness;
          if (settings.Cursor.CursorBlink is not null) TerminalControl.CursorBlink = (bool) settings.Cursor.CursorBlink;
          if (settings.Cursor.CursorBlinkRate is not null) TerminalControl.CursorBlinkRate = (int) settings.Cursor.CursorBlinkRate;
          if (settings.Cursor.CursorColor is not null) TerminalControl.CursorColor = (Color) settings.Cursor.CursorColor;
        }
      }

      if (settings.Scrollback is not null) {
        if (terminalIsInitialized) {
          if (settings.Scrollback.ScrollbackLines is not null) TerminalControl.Scrollback = (int) settings.Scrollback.ScrollbackLines;
          if (settings.Scrollback.LinesPerScrollback is not null) TerminalControl.LinesPerScrollback = (int) settings.Scrollback.LinesPerScrollback;
          if (settings.Scrollback.LinesPerSmallScrollback is not null) TerminalControl.LinesPerSmallScrollback = (int) settings.Scrollback.LinesPerSmallScrollback;
          if (settings.Scrollback.LinesPerWheelScrollback is not null) TerminalControl.LinesPerWheelScrollback = (int) settings.Scrollback.LinesPerWheelScrollback;
        }
      }

      if (settings.CopyAndPaste is not null) {
        if (terminalIsInitialized) {
          if (settings.CopyAndPaste.CopyOnMouseUp is not null) TerminalControl.CopyOnMouseUp = (bool) settings.CopyAndPaste.CopyOnMouseUp;
          if (settings.CopyAndPaste.PasteOnMiddleClick is not null) TerminalControl.PasteOnMiddleClick = (bool) settings.CopyAndPaste.PasteOnMiddleClick;
          if (settings.CopyAndPaste.PasteOnRightClick is not null) TerminalControl.PasteOnRightClick = (bool) settings.CopyAndPaste.PasteOnRightClick;
          if (settings.CopyAndPaste.CopyNewline is not null) TerminalControl.CopyNewline = settings.CopyAndPaste.CopyNewline;
        }
      }
      ...
      if (settings.ColorPalette is not null) {
        if (terminalIsInitialized) {
          if (settings.ColorPalette.DefaultColors is not null) {
            if (settings.ColorPalette.DefaultColors.DefaultBackgroundColor is not null) TerminalControl.AnsiColors.DefaultBackgroundColor = ((Color) settings.ColorPalette.DefaultColors.DefaultBackgroundColor).ToSystemDrawingColor();
            if (settings.ColorPalette.DefaultColors.DefaultForegroundColor is not null) TerminalControl.AnsiColors.DefaultForegroundColor = ((Color) settings.ColorPalette.DefaultColors.DefaultForegroundColor).ToSystemDrawingColor();
            if (settings.ColorPalette.DefaultColors.DefaultUnderlineColor is not null) TerminalControl.AnsiColors.DefaultUnderlineColor = ((Color) settings.ColorPalette.DefaultColors.DefaultUnderlineColor).ToSystemDrawingColor();
          }

          if (settings.ColorPalette.StandardColors is not null) {
            if (settings.ColorPalette.StandardColors.Black is not null) TerminalControl.AnsiColors.Black = ((Color) settings.ColorPalette.StandardColors.Black).ToSystemDrawingColor();
            if (settings.ColorPalette.StandardColors.Red is not null) TerminalControl.AnsiColors.Red = ((Color) settings.ColorPalette.StandardColors.Red).ToSystemDrawingColor();
            if (settings.ColorPalette.StandardColors.Green is not null) TerminalControl.AnsiColors.Green = ((Color) settings.ColorPalette.StandardColors.Green).ToSystemDrawingColor();
            if (settings.ColorPalette.StandardColors.Yellow is not null) TerminalControl.AnsiColors.Yellow = ((Color) settings.ColorPalette.StandardColors.Yellow).ToSystemDrawingColor();
            if (settings.ColorPalette.StandardColors.Blue is not null) TerminalControl.AnsiColors.Blue = ((Color) settings.ColorPalette.StandardColors.Blue).ToSystemDrawingColor();
            if (settings.ColorPalette.StandardColors.Magenta is not null) TerminalControl.AnsiColors.Magenta = ((Color) settings.ColorPalette.StandardColors.Magenta).ToSystemDrawingColor();
            if (settings.ColorPalette.StandardColors.Cyan is not null) TerminalControl.AnsiColors.Cyan = ((Color) settings.ColorPalette.StandardColors.Cyan).ToSystemDrawingColor();
            if (settings.ColorPalette.StandardColors.White is not null) TerminalControl.AnsiColors.White = ((Color) settings.ColorPalette.StandardColors.White).ToSystemDrawingColor();
          }

          if (settings.ColorPalette.BrightColors is not null) {
            if (settings.ColorPalette.BrightColors.BrightBlack is not null) TerminalControl.AnsiColors.BrightBlack = ((Color) settings.ColorPalette.BrightColors.BrightBlack).ToSystemDrawingColor();
            if (settings.ColorPalette.BrightColors.BrightRed is not null) TerminalControl.AnsiColors.BrightRed = ((Color) settings.ColorPalette.BrightColors.BrightRed).ToSystemDrawingColor();
            if (settings.ColorPalette.BrightColors.BrightGreen is not null) TerminalControl.AnsiColors.BrightGreen = ((Color) settings.ColorPalette.BrightColors.BrightGreen).ToSystemDrawingColor();
            if (settings.ColorPalette.BrightColors.BrightYellow is not null) TerminalControl.AnsiColors.BrightYellow = ((Color) settings.ColorPalette.BrightColors.BrightYellow).ToSystemDrawingColor();
            if (settings.ColorPalette.BrightColors.BrightBlue is not null) TerminalControl.AnsiColors.BrightBlue = ((Color) settings.ColorPalette.BrightColors.BrightBlue).ToSystemDrawingColor();
            if (settings.ColorPalette.BrightColors.BrightMagenta is not null) TerminalControl.AnsiColors.BrightMagenta = ((Color) settings.ColorPalette.BrightColors.BrightMagenta).ToSystemDrawingColor();
            if (settings.ColorPalette.BrightColors.BrightCyan is not null) TerminalControl.AnsiColors.BrightCyan = ((Color) settings.ColorPalette.BrightColors.BrightCyan).ToSystemDrawingColor();
            if (settings.ColorPalette.BrightColors.BrightWhite is not null) TerminalControl.AnsiColors.BrightWhite = ((Color) settings.ColorPalette.BrightColors.BrightWhite).ToSystemDrawingColor();
          }
        }
      }
    }
    ...
    private void TerminalControl_CustomizeSettingsWindowSettings(SettingsViewModel settingsViewModel) {
      TextSettingsItem command = new() {
        Key = nameof(dependencyProperties.Command),
        Name = resources.GetString("CommandName"),
        Getter = () => dependencyProperties.Command,
        Setter = (command) => dependencyProperties.Command = command
      };

      TextSettingsItem startDirectory = new() {
        Key = nameof(dependencyProperties.StartDirectory),
        Name = resources.GetString("StartDirectoryName"),
        Getter = () => dependencyProperties.StartDirectory is not null ? dependencyProperties.StartDirectory : string.Empty,
        Setter = (startDirectory) => dependencyProperties.StartDirectory = startDirectory == string.Empty ? null : startDirectory
      };

      CaptionSettingsItem startDirectoryCaption = new() {
        Key = "StartDirectoryCaption",
        Getter = () => dependencyProperties.StartDirectory is null ? resources.GetString("NullStartDirectoryExplanation") : resources.GetString("NonNullStartDirectoryExplanation")
      };

      BooleanSettingsItem nullStartDirectory = new() {
        Key = "NullStartDirectory",
        Name = resources.GetString("NullStartDirectoryName"),
        Getter = () => dependencyProperties.StartDirectory is null,
        Setter = (startDirectory) => {
          dependencyProperties.StartDirectory = startDirectory ? null : defaultStartDirectory;
      ...
      RadioSettingsItem defaultBackgroundColorWindowBackdrop = new() {
        ...
        Name = resources.GetString("DefaultBackgroundColorWindowBackdropName")
      };

      RadioSettingsItem micaWindowBackdrop = new() {
        Key = "MicaWindowBackdrop",
        Name = resources.GetString("MicaWindowBackdropName")
      };

      RadioSettingsItem acrylicWindowBackdrop = new() {
        Key = "AcrylicWindowBackdrop",
        Name = resources.GetString("AcrylicWindowBackdropName")
      };

      RadioSettingsItem blurredWindowBackdrop = new() {
        Key = "BlurredWindowBackdrop",
        Name = resources.GetString("BlurredWindowBackdropName")
      };

      RadioSettingsItem transparentWindowBackdrop = new() {
        Key = "TransparentWindowBackdrop",
        Name = resources.GetString("TransparentWindowBackdropName")
      };

      RadioSettingsItem solidColorWindowBackdrop = new() {
        Key = "SolidColorWindowBackdrop",
        Name = resources.GetString("SolidColorWindowBackdropName")
      };

      RadioCollectionSettingsItem windowBackdrop = new() {
        Key = nameof(dependencyProperties.WindowBackdrop),
        Name = resources.GetString("WindowBackdropName"),
        Items = [
        ...
        Getter = () => (int) dependencyProperties.WindowBackdrop,
        Setter = (windowBackdrop) => {
          if ((WindowBackdrops) windowBackdrop == WindowBackdrops.DefaultBackgroundColor) {
            dependencyProperties.SolidColorWindowBackdropColor = TerminalControl.AnsiColors.DefaultBackgroundColor.ToWindowsUIColor();
          }

          dependencyProperties.WindowBackdrop = (WindowBackdrops) windowBackdrop;
        }
      };

      ColorSettingsItem solidColorWindowBackdropColor = new() {
        Key = nameof(dependencyProperties.SolidColorWindowBackdropColor),
        Name = resources.GetString("SolidColorWindowBackdropColorName"),
        Getter = () => dependencyProperties.SolidColorWindowBackdropColor,
        Setter = (solidColorWindowBackdropColor) => dependencyProperties.SolidColorWindowBackdropColor = solidColorWindowBackdropColor
      };

      IntegerSettingsItem visualBellDisplayTime = new() {
        Key = nameof(dependencyProperties.VisualBellDisplayTime),
        Name = resources.GetString("VisualBellDisplayTimeName"),
        Getter = () => dependencyProperties.VisualBellDisplayTime,
        Setter = (visualBellDisplayTime) => dependencyProperties.VisualBellDisplayTime = visualBellDisplayTime,
        SmallChange = 1,
        LargeChange = 1
      };
      ...
      SettingsGroup advanced = new() {
        Key = "Advanced",
        Name = resources.GetString("AdvancedName"),
        Items = [
      ...
      ColorSettingsItem defaultBackgroundColor = new() {
        ...
        Name = resources.GetString("DefaultBackgroundColorName"),
        ...
        Setter = (defaultBackgroundColor) => {
          ...
          if (dependencyProperties.WindowBackdrop == WindowBackdrops.DefaultBackgroundColor) {
      ...
      ColorSettingsItem defaultForegroundColor = new() {
        ...
        Name = resources.GetString("DefaultForegroundColorName"),
      ...
      ColorSettingsItem defaultUnderlineColor = new() {
        ...
        Name = resources.GetString("DefaultUnderlineColorName"),
      ...
      ColorSettingsItem blackStandardColor = new() {
        ...
        Name = resources.GetString("BlackStandardColorName"),
      ...
      ColorSettingsItem redStandardColor = new() {
        ...
        Name = resources.GetString("RedStandardColorName"),
      ...
      ColorSettingsItem greenStandardColor = new() {
        ...
        Name = resources.GetString("GreenStandardColorName"),
      ...
      ColorSettingsItem yellowStandardColor = new() {
        ...
        Name = resources.GetString("YellowStandardColorName"),
      ...
      ColorSettingsItem blueStandardColor = new() {
        ...
        Name = resources.GetString("BlueStandardColorName"),
      ...
      ColorSettingsItem magentaStandardColor = new() {
        ...
        Name = resources.GetString("MagentaStandardColorName"),
      ...
      ColorSettingsItem cyanStandardColor = new() {
        ...
        Name = resources.GetString("CyanStandardColorName"),
      ...
      ColorSettingsItem whiteStandardColor = new() {
        ...
        Name = resources.GetString("WhiteStandardColorName"),
      ...
      ColorSettingsItem blackBrightColor = new() {
        ...
        Name = resources.GetString("BlackBrightColorName"),
      ...
      ColorSettingsItem redBrightColor = new() {
        Key = "RedBrightColor",
        Name = resources.GetString("RedBrightColorName"),
      ...
      ColorSettingsItem greenBrightColor = new() {
        ...
        Name = resources.GetString("GreenBrightColorName"),
      ...
      ColorSettingsItem yellowBrightColor = new() {
        ...
        Name = resources.GetString("YellowBrightColorName"),
      ...
      ColorSettingsItem blueBrightColor = new() {
        Key = "BlueBrightColor",
        Name = resources.GetString("BlueBrightColorName"),
      ...
      ColorSettingsItem magentaBrightColor = new() {
        ...
        Name = resources.GetString("MagentaBrightColorName"),
      ...
      ColorSettingsItem cyanBrightColor = new() {
        Key = "CyanBrightColor",
        Name = resources.GetString("CyanBrightColorName"),
      ...
      ColorSettingsItem whiteBrightColor = new() {
        ...
        Name = resources.GetString("WhiteBrightColorName"),
      ...
      SettingsGroup colorPalette = new() {
        Key = "ColorPalette",
        Name = resources.GetString("ColorPaletteName"),
        Items = [
          new GroupSettingsItem() {
            Key = "DefaultColors",
            Name = resources.GetString("DefaultColorsName"),
            Items = [
          ...
          new GroupSettingsItem() {
            Key = "StandardColors",
            Name = resources.GetString("StandardColorsName"),
            Items = [
              blackStandardColor,
              redStandardColor,
              greenStandardColor,
          ...
          new GroupSettingsItem() {
            Key = "BrightColors",
            Name = resources.GetString("BrightColorsName"),
            Items = [
              blackBrightColor,
              redBrightColor,
              greenBrightColor,
      ...
      for (int i = 0; i < settingsViewModel.Groups.Count; i++) {
        ...
        if (settingsGroup.Key == "Basics") {
          ...
          settingsGroup.Items.Insert(1, new CaptionSettingsItem() { Key = "CommandCaption", Getter = () => resources.GetString("CommandExplanation") });

          settingsGroup.Items.Add(
            new GroupSettingsItem() {
              Key = "BasicsWorkingDirectory",
              Name = resources.GetString("BasicsWorkingDirectoryName"),
              Items = [
                startDirectory,
                nullStartDirectory,
      ...
      settingsViewModel.CallbackTokens.Add(
        ...
        dependencyProperties.RegisterPropertyChangedCallback(
          DependencyProperties.CommandProperty,
          (_, _) => command.BoundValue = dependencyProperties.Command
        )
      );
      ...
      settingsViewModel.CallbackTokens.Add(
        ...
        dependencyProperties.RegisterPropertyChangedCallback(
          DependencyProperties.StartDirectoryProperty,
          (_, _) => {
            startDirectory.BoundValue = dependencyProperties.StartDirectory is null ? string.Empty : dependencyProperties.StartDirectory;
            nullStartDirectory.BoundValue = dependencyProperties.StartDirectory is null;
          }
        )
      );
      ...
      settingsViewModel.CallbackTokens.Add(
        ...
        dependencyProperties.RegisterPropertyChangedCallback(
          DependencyProperties.WindowBackdropProperty,
          (_, _) => windowBackdrop.BoundValue = (int) dependencyProperties.WindowBackdrop
        )
      );
      ...
      settingsViewModel.CallbackTokens.Add(
        ...
        dependencyProperties.RegisterPropertyChangedCallback(
          DependencyProperties.SolidColorWindowBackdropColorProperty,
          (_, _) => solidColorWindowBackdropColor.BoundValue = dependencyProperties.SolidColorWindowBackdropColor
        )
      );
      ...
      settingsViewModel.CallbackTokens.Add(
        ...
        dependencyProperties.RegisterPropertyChangedCallback(
          DependencyProperties.VisualBellDisplayTimeProperty,
          (_, _) => visualBellDisplayTime.BoundValue = dependencyProperties.VisualBellDisplayTime
        )
      );
    }
...
#pragma warning restore IDE0079 // Remove unnecessary suppression
    private void TerminalControl_SaveSettingsAsDefaults() {
      Settings.Json.Settings settings = new() {
        Basics = new() {
          Command = dependencyProperties.Command,
          ...
          StartDirectory = dependencyProperties.StartDirectory
        },

        Appearance = new() {
          WindowBackdrop = dependencyProperties.WindowBackdrop,
        ...
        Behavior = new() {
          ...
          VisualBellDisplayTime = dependencyProperties.VisualBellDisplayTime,
      ...
      try {
        ...
        ShowErrorDialog(TerminalControl.SettingsWindow!.Content.XamlRoot, resources.GetString("CouldNotSaveSettings"), e);
      }

      if (writeSucceeded) {
        AppNotificationManager.Default.Show(
          new AppNotificationBuilder()
            .AddText(resources.GetString("SettingsSaved"))
            .AddText(resources.GetString("DefaultSettingsHaveBeenSaved"))
            .BuildNotification()
        );
      }
    }
    ...
    /// <summary>
    /// Invoked when <see cref="settingsJsonWatcher"/> detects a change to the
    /// settings JSON file.
    /// </summary>
    ...
    private void SettingsJsonWatcher_Changed(object sender, FileSystemEventArgs e) {
      ...
      if (settingsSaveTimer.Enabled) return;

      // Ignore events if the settings window is not open
      if (TerminalControl.SettingsWindow is null) return;
    ...
    /// </summary>
    /// <param name="xamlRoot">The <see cref="XamlRoot"/> in which to present
    /// the dialog.</param>
    ...
    private async void ShowErrorDialog(XamlRoot xamlRoot, string title, Exception e) {
      ...
      ContentDialog dialog = new() {
        ...
        Title = title,
        CloseButtonText = resources.GetString("CloseButtonCaption"),
