...
namespace ConPTY.Win32.Interop {
  ...
  /// information, ensuring that resources such as attribute lists and handles
  /// are properly released when the instance is disposed. Instances of this
  /// class are intended to be used with unmanaged process creation
  /// scenarios.</remarks>
