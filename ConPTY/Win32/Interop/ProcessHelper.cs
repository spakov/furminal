...
namespace Spakov.ConPTY.Win32.Interop
{
    ...
    internal static class ProcessHelper
    {
        ...
        /// <summary>
        /// Configures a process thread with the specified pseudo console
        /// handle and attribute.
        /// </summary>
        ...
        /// caller is responsible for ensuring that the returned structure and
        /// its associated resources are properly disposed of to avoid memory
        /// leaks.</remarks>
        ...
        /// Windows API calls fail, such as initializing or updating the
        /// process thread attribute list.</exception>
        ...
        /// name="startupInfoExW"/> and <paramref name="commandLine"/> are
        /// valid and meet the requirements of the underlying API. If the
        /// process creation fails, the method throws a <see
        /// cref="Win32Exception"/> with the relevant error code.</remarks>
        /// <param name="startupInfoExW">A reference to a <see
        /// cref="STARTUPINFOEXW"/> structure that specifies the extended
        /// startup information for the process.</param>
        /// <param name="commandLine">The command line to execute, including
        /// the application name and any arguments. This cannot be <see
        ...
        /// thread.</returns>
        /// <exception cref="Win32Exception">Thrown if the process creation
        /// fails. The exception's error code will contain the result of the
        /// last Win32 error.</exception>
