...
namespace Terminal {
  public sealed partial class TerminalControl : UserControl {
    ...
    private static void OnConsoleOutputChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.AnsiReader = terminalControl.ConsoleOutput is not null
        ? new(
    ...
    private static void OnConsoleInputChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.AnsiWriter = terminalControl.ConsoleInput is not null
        ? new(
    ...
    private static void OnAnsiColorsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      if (terminalControl.terminalEngine.AnsiReader is not null) {
        terminalControl.terminalEngine.AnsiReader.Palette = terminalControl.AnsiColors;
      }
    ...
    /// <summary>
    /// The <see cref="AnsiProcessor.TermCap.TerminalCapabilities"/> associated
    /// with the terminal.
    /// </summary>
    ...
    private static void OnTerminalCapabilitiesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.TerminalCapabilities = terminalControl.TerminalCapabilities;
    }
    ...
    private static void OnRowsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.Rows = terminalControl.Rows;
    ...
    private static void OnColumnsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.Columns = terminalControl.Columns;
      terminalControl.InvalidateMeasure();
      terminalControl.ReportWindowSize();
      terminalControl.TerminalResize?.Invoke();
    }
    ...
    private static void OnScrollbackChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.Scrollback = terminalControl.Scrollback;
    }
    ...
    /// <summary>
    /// The number of lines to shift when using scrollback via Shift-Page Up
    /// and Shift-Page Down.
    /// </summary>
    ...
    /// <summary>
    /// The number of lines to shift when using scrollback via the mouse wheel.
    /// </summary>
    ...
    private static void OnFontFamilyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.FontFamily = terminalControl.FontFamily;
      terminalControl.InvalidateMeasure();
    }
    ...
    /// <summary>
    /// Whether escape sequences that erase characters should cause the cell to
    /// use the current graphic rendition background color.
    /// </summary>
    ...
    /// <summary>
    /// Whether backgrounds should be rendered invisible and "show through" to
    ...
    private static void OnBackgroundIsInvisibleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.BackgroundIsInvisible = terminalControl.BackgroundIsInvisible;
    ...
    private static void OnUseVisualBellChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.UseVisualBell = terminalControl.UseVisualBell;
    ...
    public CursorStyles CursorStyle {
      get => (CursorStyles) GetValue(CursorStyleProperty);
    ...
    public static readonly DependencyProperty CursorStyleProperty = DependencyProperty.Register(
      ...
      typeof(CursorStyles),
      typeof(TerminalControl),
      new PropertyMetadata(CursorStyles.Block, OnCursorStyleChanged)
    );
    ...
    private static void OnCursorBlinkChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.CursorBlink = terminalControl.CursorBlink;
    ...
    /// <summary>
    /// Whether to copy text immediately after releasing the mouse button after
    /// selecting it.
    /// </summary>
    ...
    private static void OnCopyOnMouseUpChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.CopyOnMouseUp = terminalControl.CopyOnMouseUp;
    ...
    private static void OnCopyNewlineChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
      ...
      terminalControl.terminalEngine.CopyNewline = terminalControl.CopyNewline;
    }
    ...
    /// </summary>
    /// <remarks>If <see langword="true"/>, the context menu is displayed with
    /// Ctrl+Right Click. If <see langword="false"/>, the context menu is
    /// displayed with Right Click.</remarks>
    ...
    /// <summary>
    /// Whether to display a context menu on Right Click (or Ctrl+Right Click,
    /// if <see cref="PasteOnRightClick"/> is <see langword="true"/>).
    /// </summary>
