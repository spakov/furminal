...
namespace Spakov.Terminal
{
    ...
    internal struct Cell
    {
        ...
        /// <summary>
        /// The <see cref="AnsiProcessor.Output.GraphicRendition"/> used to
        /// draw this <see cref="Cell"/>.
        /// </summary>
        ...
        {
            if (a.GraphemeCluster != b.GraphemeCluster)
            {
                return false;
            }

            if (a.GraphicRendition != b.GraphicRendition)
            {
                return false;
            }
