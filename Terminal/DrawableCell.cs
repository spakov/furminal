...
{
    /// <summary>
    /// A cell to be drawn by the <see cref="TerminalRenderer"/>, plus
    /// metadata.
    /// </summary>
    internal struct DrawableCell
    {
        /// <summary>
        /// The caret position at which to draw the <see
        /// cref="Terminal.Cell"/>.
        /// </summary>
        public Caret Caret;

        /// <summary>
        /// The pixel position at which to draw the <see
        /// cref="Terminal.Cell"/>.
        /// </summary>
        ...
        public static bool operator ==(DrawableCell a, DrawableCell b)
        {
            ...
            if (a.CellFingerprint != b.CellFingerprint)
            {
                return false;
            }
