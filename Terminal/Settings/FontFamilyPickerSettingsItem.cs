...
namespace Spakov.Terminal.Settings
{
    ...
    /// cref="Microsoft.UI.Xaml.Controls.ToggleSwitch"/> to filter by
    /// fixed-width fonts.
    /// </summary>
    public partial class FontFamilyPickerSettingsItem : SettingsItem
    {
        ...
        /// </summary>
        /// <remarks>Fixed-width fonts are determined by laying out text
        /// samples, which is a non-trivial operation. This is potentially
        /// GPU-bound.</remarks>
