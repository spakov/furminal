...
namespace Spakov.Terminal.Settings
{
    public class SettingsViewModel
    {
        ...
        /// </summary>
        public Dictionary<DependencyProperty, long> CallbackTokens => _callbackTokens;

        /// <summary>
        /// Initializes a <see cref="SettingsViewModel"/>.
        /// </summary>
        /// <remarks>
        /// <para><see cref="Groups"/> can be customized after instantiation
        /// but before display by creating a callback for <see
        ...
        /// cref="SettingsItem"/> or objects of type <see
        /// cref="SettingsGroup"/> containing such objects.</item>
        ...
        internal SettingsViewModel(TerminalControl terminalControl)
        {
            ...
            RadioCollectionSettingsItem textAntialiasing = new()
            {
                ...
                Setter = (textAntialiasing) => terminalControl.TextAntialiasing = (TextAntialiasingStyle)textAntialiasing
            };
            ...
            BooleanSettingsItem cursorStyleBlock = new()
            {
                ...
                Getter = () => terminalControl.CursorStyle == CursorStyle.Block,
                Setter = (cursorStyleBlock) =>
                {
                    terminalControl.CursorStyle = cursorStyleBlock
                        ? CursorStyle.Block
                        : terminalControl.CursorStyle == CursorStyle.Bar
                            ? CursorStyle.Bar
            ...
            BooleanSettingsItem cursorStyleUnderline = new()
            {
                ...
                Getter = () => terminalControl.CursorStyle == CursorStyle.Underline,
                Setter = (cursorStyleUnderline) =>
                {
                    terminalControl.CursorStyle = cursorStyleUnderline
                        ? CursorStyle.Underline
                        : terminalControl.CursorStyle == CursorStyle.Block
                            ? CursorStyle.Block
                            : CursorStyle.Bar;
                }
            };
            ...
            BooleanSettingsItem cursorStyleBar = new()
            {
                ...
                Getter = () => terminalControl.CursorStyle == CursorStyle.Bar,
                Setter = (cursorStyleBar) =>
                {
                    terminalControl.CursorStyle = cursorStyleBar
                        ? CursorStyle.Bar
                        : terminalControl.CursorStyle == CursorStyle.Underline
                            ? CursorStyle.Underline
                            : CursorStyle.Block;
                }
            };
            ...
            _callbackTokens.Add(
                ...
                terminalControl.RegisterPropertyChangedCallback(
                    ...
                    (_, _) =>
                    {
                        cursorStyleBlock.BoundValue = terminalControl.CursorStyle == CursorStyle.Block;
                        cursorStyleUnderline.BoundValue = terminalControl.CursorStyle == CursorStyle.Underline;
                        cursorStyleBar.BoundValue = terminalControl.CursorStyle == CursorStyle.Bar;
                    }
                )
            );
