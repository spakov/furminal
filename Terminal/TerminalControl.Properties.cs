...
namespace Spakov.Terminal
{
    public sealed partial class TerminalControl : UserControl
    {
        ...
        /// </summary>
        /// <remarks>Clamps to the nearest integral number of rows and columns
        /// when setting.</remarks>
        public SizeF NominalSizeInPixels
        {
            get => _terminalEngine.NominalSizeInPixels;

            set
            {
                if (_terminalEngine.CellSize.Width == 0.0 || _terminalEngine.CellSize.Height == 0.0)
                {
                    return;
                }

                int newColumns = (int)(value.Width / _terminalEngine.CellSize.Width);
                int newRows = (int)(value.Height / _terminalEngine.CellSize.Height);
                ...
                if (newColumns > 0 && newRows > 0)
                {
                    ...
                    double offsetX = (value.Width - _terminalEngine.NominalSizeInPixels.Width) / 2;
                    double offsetY = (value.Height - _terminalEngine.NominalSizeInPixels.Height) / 2;
                    ...
                    logger?.LogDebug("  Cell size(width, height): ({width:F}, {height:F})", _terminalEngine.CellSize.Width, _terminalEngine.CellSize.Height);
        ...
        /// <summary>
        /// A <see cref="Windows.ApplicationModel.Resources.ResourceLoader"/>
        /// for i18n.
        /// </summary>
        internal ResourceLoader ResourceLoader => _resourceLoader;

        /// <summary>
        /// The <see cref="Terminal.TerminalEngine"/>.
        /// </summary>
        internal TerminalEngine TerminalEngine => _terminalEngine;

        /// <summary>
        /// The UI thread <see
        /// cref="Microsoft.UI.Dispatching.DispatcherQueue"/>.
        /// </summary>
        ...
        /// </summary>
        internal MouseButton LastMouseButton
        {
