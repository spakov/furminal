    ...
    internal static class CursorHelper
    {
        ...
        internal static void DrawCursor(TerminalControl terminalControl, CanvasDrawingSession drawingSession)
        {
            ...
            )
            {
                ...
                if (terminalControl.CursorStyle == CursorStyle.Block)
                {
                ...
                else if (terminalControl.CursorStyle == CursorStyle.Underline)
                {
                ...
                else if (terminalControl.CursorStyle == CursorStyle.Bar)
                {
        ...
        /// <param name="terminalControl">A <see
        /// cref="TerminalControl"/>.</param>
        /// <remarks>This is intended to be invoked on change of
        /// focus.</remarks>
        ...
        /// cref="TerminalControl.HasFocus"/> is <see
