...
namespace Spakov.Terminal.Helpers
{
    ...
    internal static class MenuHelper
    {
        ...
        /// <summary>
        /// Returns a <see cref="MenuFlyoutItemBase"/> corresponding to
        /// <paramref name="menuItemName"/>.
        /// </summary>
        /// <param name="terminalControl">A <see
        /// cref="TerminalControl"/>.</param>
        ...
        internal static MenuFlyoutItemBase InitializeMenuItem(TerminalControl terminalControl, string menuItemName)
        {
            ...
            menuItem = menuItemName switch
            {
                ...
                "BlockCursorMenuItem" => new ToggleMenuFlyoutItem()
                {
                    ...
                    IsChecked = terminalControl.CursorStyle == CursorStyle.Block
                },
                ...
                "UnderlineCursorMenuItem" => new ToggleMenuFlyoutItem()
                {
                    ...
                    IsChecked = terminalControl.CursorStyle == CursorStyle.Underline
                },
                ...
                "BarCursorMenuItem" => new ToggleMenuFlyoutItem()
                {
                    ...
                    IsChecked = terminalControl.CursorStyle == CursorStyle.Bar
                },
