...
namespace Spakov.Terminal
{
    ...
    /// methods.</para>
    /// <para><c>TerminalControl.Properties.cs</c> contains both properties
    /// that can be interacted with by the <see cref="TerminalControl"/>
    /// consumer and properties that are used by <see
    /// cref="TerminalControl"/>.</para>
    /// </remarks>
    public sealed partial class TerminalControl : UserControl
    {
        ...
        {
            logger = LoggerHelper.CreateLogger<TerminalControl>();
            ...
            _terminalEngine = new(this, Canvas);
        }

        /// <summary>
        /// Writes a message to the terminal.
        /// </summary>
        /// <remarks>Keep in mind that the source of the message may be
        /// confusing to the user.</remarks>
        /// <param name="message"></param>
        public void Write(string message) => _terminalEngine.VideoTerminal.Write(message);
        ...
        /// <param name="message"></param>
        public void WriteError(string message) => _terminalEngine.VideoTerminal.WriteError(message);
