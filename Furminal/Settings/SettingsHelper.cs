using Spakov.Furminal.Settings.Json;
...
namespace Spakov.Furminal.Settings
{
    ...
    internal static partial class SettingsHelper
    {
        ...
        internal static void GenerateSchema()
        {
            ...
            string filename = $"Furminal-{Assembly.GetExecutingAssembly().GetName().Version!.Major}.{Assembly.GetExecutingAssembly().GetName().Version!.Minor}-schema.json";
            ...
            PInvoke.MessageBox(
                ...
                App.ResourceLoader.GetString("FurminalSchemaGenerated"),
