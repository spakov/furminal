...
namespace Spakov.Furminal.Settings
{
    /// <summary>
    /// A wrapper for <see cref="DependencyProperty"/>s, since <see
    /// href="https://github.com/microsoft/microsoft-ui-xaml/issues/7305"
    /// >Window is not a DependencyObject</see>.
    /// </summary>
    ...
    public class DependencyProperties(Views.Terminal terminal) : DependencyObject
    {
        ...
        /// </summary>
        /// <remarks>Set to <see langword="null"/> to inherit the current
        /// working directory from the launching process.</remarks>
        ...
        public static readonly DependencyProperty WindowBackdropProperty = DependencyProperty.Register(
            ...
            typeof(TerminalControl),
            new PropertyMetadata(WindowBackdrop.Mica, OnWindowBackdropChanged)
        );
        ...
        private static void OnWindowBackdropChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (dependencyProperties.WindowBackdrop == (WindowBackdrop)(-1))
            {
                return;
            }
            ...
            {
                WindowBackdrop.DefaultBackgroundColor => new SolidColorBackdrop(dependencyProperties.SolidColorWindowBackdropColor),
                WindowBackdrop.Mica => Views.Terminal.MicaWindowBackdrop,
                WindowBackdrop.Acrylic => Views.Terminal.AcrylicWindowBackdrop,
                WindowBackdrop.Blurred => Views.Terminal.BlurredWindowBackdrop,
                WindowBackdrop.Transparent => Views.Terminal.TransparentWindowBackdrop,
                WindowBackdrop.SolidColor => new SolidColorBackdrop(dependencyProperties.SolidColorWindowBackdropColor),
