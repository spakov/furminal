...
{
    /// <summary>
    /// A graphic rendition, which is what an <see
    /// cref="EscapeSequences.Fe.CSI.SGR.SGREscapeSequence"/> escape sequence
    /// modifies.
    /// </summary>
    public struct GraphicRendition
    {
        ...
        public static bool operator ==(GraphicRendition a, GraphicRendition b)
        {
            ...
            if (a.DoubleUnderline != b.DoubleUnderline)
            {
                return false;
            }

            if (a.ForegroundColor != b.ForegroundColor)
            {
                return false;
            }
            ...
            if (a.UnderlineColor != b.UnderlineColor)
            {
                return false;
            }
