...
{
    /// <summary>
    /// A representation of an ANSI <see cref="Ansi.EscapeSequences.Fp"/>
    /// escape sequence.
    /// </summary>
    public class FpEscapeSequence : EscapeSequence
    {
        ...
        /// </summary>
        /// <param name="rawFpEscapeSequence">The raw Fp escape
        /// sequence.</param>
        ...
        /// </summary>
        /// <remarks>
        /// <para>Since an Fp escape sequence is only two characters, the
