...
namespace Spakov.AnsiProcessor.Output.EscapeSequences.Fe.CSI
{
    ...
    /// <para>There is no guarantee that any of the properties make sense or
    /// are valid—they are merely what was sent to <see
    ...
    /// <para>Unsupported CSI sequences, per the reference below, either
    /// because they're highly xterm-specific, highly non-Windows-specific,
    /// highly DEC-specific, or just plain not used these days:</para>
    /// <list type="bullet">
    ...
    /// <item><c>CSI Pi ; Pg ; Pt ; Pl ; Pb ; Pr * y</c>,
    /// <c>DECRQCRA</c></item>
    ...
    public class CSIEscapeSequence : FeEscapeSequence
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para><see langword="null"/> if the variant is not
        /// applicable.</para>
        /// <para>This can be used to distinguish between, e.g., <c>CSI Ps
        /// @</c> and <c>CSI Ps SP @</c>, where <see cref="Variant"/> would be
        /// a space character in the latter case, but <see langword="null"/> in
        /// the former case.</para>
        /// </remarks>
        ...
        /// <param name="type"><inheritdoc
        /// cref="Type" path="/summary"/></param>
        /// <param name="variant"><inheritdoc cref="Variant"
        /// path="/summary"/></param>
        /// <param name="rawCSIEscapeSequence">The raw CSI escape
        /// sequence.</param>
        ...
        /// <summary>
        /// Initializes a <see cref="CSIEscapeSequence"/>, or more likely, one
        /// of its subclasses.
        /// </summary>
        ...
        internal static CSIEscapeSequence InitializeCSIEscapeSequence(TerminalCapabilities terminalCapabilities, Palette palette, string rawCSIEscapeSequence)
        {
            ...
            else
            {
                ...
                )
                {
                    ...
                    { // Sequences that have a default Ps of 1 (most of them)
                        defaultFirst = 1;
                    }
                }
        ...
        /// <summary>
        /// Converts <paramref name="stringPs"/> to a <see cref="List{T}"/> of
        /// <see langword="int"/>s.
        /// </summary>
        ...
        /// <param name="defaultFirst">If not <see langword="null"/>, ensure
        /// the returned <see cref="List{T}"/> will contain a single <paramref
        /// name="defaultFirst"/> instead of being an empty list.</param>
        /// <returns>A <see cref="List{T}"/> of <see
        /// langword="int"/>s.</returns>
