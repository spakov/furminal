...
{
    /// <summary>
    /// A representation of an ANSI <see cref="Ansi.EscapeSequences.NF"/>
    /// escape sequence.
    /// </summary>
    public class NFEscapeSequence : EscapeSequence
    {
        ...
        /// </summary>
        /// <param name="rawNFEscapeSequence">The raw nF escape
        /// sequence.</param>
        ...
        /// <summary>
        /// Determines whether <paramref name="terminalCapabilities"/> states
        /// that <paramref name="character"/> should be handled.
        /// </summary>
        /// <param name="terminalCapabilities">A <see
        /// cref="TerminalCapabilities"/>.</param>
        /// <param name="character">The character to check.</param>
        /// <returns><see langword="true"/> if <paramref name="character"/>
        /// should be handled or <see langword="false"/> otherwise.</returns>
        internal static bool NFEscapeSequenceMatches(TerminalCapabilities terminalCapabilities, char character)
        {
            if (terminalCapabilities.ControlCharacters?.EscapeSequences is null)
            {
                return false;
            }
