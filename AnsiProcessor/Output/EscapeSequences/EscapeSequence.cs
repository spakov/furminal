...
namespace Spakov.AnsiProcessor.Output.EscapeSequences
{
    ...
    public class EscapeSequence
    {
        ...
        /// <summary>
        /// Initializes an <see cref="EscapeSequence"/>, or more likely, one of
        /// its subclasses.
        /// </summary>
        /// <param name="terminalCapabilities">A <see
        /// cref="TerminalCapabilities"/>.</param>
        /// <param name="palette">A <see cref="Palette"/>.</param>
        /// <param name="rawEscapeSequence">The raw escape sequence from which
        /// to initialize an object.</param>
        /// <param name="escapeSequenceState">The <see
        /// cref="EscapeSequenceState"/> corresponding to the reader upon
        /// processing <paramref name="rawEscapeSequence"/>.</param>
        ...
        /// name="character"/>, based on <paramref
        ...
        /// langword="null"/> if <paramref name="character"/> represents an
        /// escape sequence this is not configured in <paramref
