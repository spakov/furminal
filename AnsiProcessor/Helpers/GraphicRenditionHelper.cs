...
namespace Spakov.AnsiProcessor.Helpers
{
    ...
    {
        /// <summary>
        /// Initializes a <see cref="GraphicRendition"/> from the default
        /// colors defined in <paramref name="palette"/>.
        /// </summary>
        /// <remarks>
        ...
        public static void InitializeFromPalette(this ref GraphicRendition graphicRendition, Palette palette)
        {
            ...
            graphicRendition.UnderlineStyle = UnderlineStyle.None;
        }
        ...
        public static void MergeFrom(this ref GraphicRendition graphicRendition, SGREscapeSequence sgrEscapeSequence)
        {
            ...
            if (graphicRendition.Underline && graphicRendition.UnderlineStyle == UnderlineStyle.None)
            {
                graphicRendition.UnderlineStyle = UnderlineStyle.Single;
            }
        }
    }
}
