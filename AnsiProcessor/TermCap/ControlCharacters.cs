...
namespace Spakov.AnsiProcessor.TermCap
{
    ...
    public class ControlCharacters
    {
        ...
        /// <summary>
        /// Whether to allow bare <see cref="Ansi.C1"/> control characters to
        /// cause <see cref="AnsiReader.OnControlCharacter"/> to be invoked,
        /// rather than only <see cref="Ansi.C1"/> control characters preceded
        /// by <see cref="Ansi.C0.ESC"/> (which are delivered via <see
