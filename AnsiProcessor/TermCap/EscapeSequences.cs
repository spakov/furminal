...
namespace Spakov.AnsiProcessor.TermCap
{
    ...
    {
        /// <summary>
        /// <see cref="Ansi.EscapeSequences.Fe"/> escape sequences
        /// configuration.
        /// </summary>
        ...
        /// <summary>
        /// <see cref="Ansi.EscapeSequences.Fp"/> escape sequences
        /// configuration.
        /// </summary>
        /// <remarks>Add escape sequences to the list that should cause
        /// <see cref="AnsiReader.OnEscapeSequence"/> to be invoked.</remarks>
        ...
        /// <summary>
        /// <see cref="Ansi.EscapeSequences.Fs"/> escape sequences
        /// configuration.
        /// </summary>
        /// <remarks>Add escape sequences to the list that should cause
        /// <see cref="AnsiReader.OnEscapeSequence"/> to be invoked.</remarks>
        ...
        /// <summary>
        /// <see cref="Ansi.EscapeSequences.NF"/> escape sequences
        /// configuration.
        /// </summary>
        /// <remarks>Add escape sequences to the list that should cause
        /// <see cref="AnsiReader.OnEscapeSequence"/> to be invoked.</remarks>
