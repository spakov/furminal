namespace Spakov.AnsiProcessor.Ansi.EscapeSequences
{
    ...
    /// <c>0x20-0x2f</c>, followed by additional bytes], where the bracketed
    /// text refers to the constants defined in <see cref="NF"/>.
    /// </summary>
    /// <remarks>
    /// Sources:
    /// <list type="bullet">
    ...
    public static class NF
    {
        ...
        /// <summary>
        /// The DEC double-height line (DECDHL), bottom half character
        /// sequence.
        /// </summary>
