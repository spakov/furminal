namespace Spakov.AnsiProcessor.Ansi.EscapeSequences
{
    ...
    /// cref="C0.ESC"/>, followed by <see cref="Fe.CSI"/>, followed by an
    /// encoded integer (the constants in <see cref="SGR"/>), followed by <see
    /// cref="SGR.TERMINATOR"/>.
    /// </summary>
    /// <remarks>
    /// <para>Sources:</para>
    ...
    /// </list>
    /// <para>I see absolutely no non-nefarious reason for choosing to use 8
    /// and 28 these days, so I am explicitly deciding not to support
    /// those.</para>
    /// </remarks>
