...
{
    /// <summary>
    /// The CSI mouse tracking extension escape sequences, which are either
    /// (for X10/11) <see cref="C0.ESC"/>, followed by <see cref="C1.CSI"/>,
    /// followed by <see cref="MOUSE_TRACKING_LEADER"/>, followed by <c>Cb</c>,
    /// followed by <c>Cx</c>, followed by <c>Cy</c>, or (for SGR) <see
