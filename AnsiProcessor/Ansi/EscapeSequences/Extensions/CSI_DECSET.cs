namespace Spakov.AnsiProcessor.Ansi.EscapeSequences.Extensions
{
    ...
    /// cref="DECSET_LEADER"/>, followed by a DECSET sequence, followed by
    /// either <see cref="CSI.DECSET_HIGH"/> (on) or <see
    ...
    public static class CSI_DECSET
    {
        ...
        /// <summary>
        /// The DEC designate USASCII for character sets G0-G3 (DECANM), VT100,
        /// and set VT100 mode value.
        /// </summary>
        ...
        /// <summary>
        /// The DEC do not clear screen when DECCOLM is set/reset (DECNCSM)
        /// value.
        /// </summary>
        public const int DECSET_DECNCSM = 95;

        /// <summary>
        /// The xterm send mouse X &amp; Y on button press and release (X11)
        /// value.
        /// </summary>
        ...
        /// <summary>
        /// The xterm enable urgency window manager hint when Control-G is
        /// received value.
        /// </summary>
        ...
        /// <summary>
        /// The in-band window resize notification response separator
        /// character.
        /// </summary>
        public const char DECSET_WINDOW_RESIZE_SEPARATOR = ';';

        /// <summary>
        /// The in-band window resize notification response termination
        /// character.
        /// </summary>
        ...
        /// href="https://invisible-island.net/xterm/modified-keys.html"/> and
        /// <see href="https://www.leonerd.org.uk/hacks/fixterms/"/> for more
        /// on this. (It's fascinating to me that Microsoft developed yet
        /// another standard for keystroke encoding when there are already at
        /// least three others. I mean, I get why, but still.)</para>
        /// </remarks>
