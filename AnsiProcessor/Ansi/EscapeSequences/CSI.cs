namespace Spakov.AnsiProcessor.Ansi.EscapeSequences
{
    ...
    /// cref="C0.ESC"/>, followed by <see cref="Fe.CSI"/>, followed by
    /// parameter bytes, followed by intermediate bytes, followed by a final
    /// byte (the constants defined in <see cref="CSI"/>).
    /// </summary>
    /// <remarks>
    /// Sources:
    /// <list type="bullet">
    ...
    public static class CSI
    {
        ...
        /// <summary>
        /// The xterm report position on title-stack (XTTITLEPOS) separator
        /// character.
        /// </summary>
        ...
        /// <summary>
        /// The DEC private mode set (DECSET) "high" character (properly known
        /// as DECSET).
        /// </summary>
        ...
        /// <summary>
        /// The DEC private mode set (DECSET) "low" character (properly known
        /// as DECRST).
        /// </summary>
        ...
        /// <summary>
        /// The xterm key modifier options (XTMODKEYS) character (which is
        /// indeed the same as <see cref="SGR"/>).
        /// </summary>
