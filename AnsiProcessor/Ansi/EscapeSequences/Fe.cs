namespace Spakov.AnsiProcessor.Ansi.EscapeSequences
{
    ...
    public static class Fe
    {
        ...
        /// <summary>
        /// The printable representation of the high octet preset (HOP)
        /// character.
        /// </summary>
        ...
        /// <summary>
        /// The printable representation of the partial line down (PLD)
        /// character.
        /// </summary>
        public const char PLD = (char)((byte)C1.PLD - C1.Offset);

        /// <summary>
        /// The printable representation of the partial line up (PLU)
        /// character.
        /// </summary>
        ...
        /// <summary>
        /// The printable representation of the set transmit state (STS)
        /// character.
        /// </summary>
        ...
        /// <summary>
        /// The printable representation of the start of string (SOS)
        /// character.
        /// </summary>
        ...
        /// <summary>
        /// The printable representation of the single character introducer
        /// (SCI) character.
        /// </summary>
        public const char SCI = (char)((byte)C1.SCI - C1.Offset);

        /// <summary>
        /// The printable representation of the control sequence introducer
        /// (CSI) character.
        /// </summary>
        public const char CSI = (char)((byte)C1.CSI - C1.Offset);

        /// <summary>
        /// The printable representation of the string terminator (ST)
        /// character.
        /// </summary>
        public const char ST = (char)((byte)C1.ST - C1.Offset);

        /// <summary>
        /// The printable representation of the operating system command
        /// character.
        /// </summary>
        ...
        /// <summary>
        /// The printable representation of the application program command
        /// (APC) character.
        /// </summary>
